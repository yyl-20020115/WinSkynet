...
#else
#include <intrin.h>
#define ATOM_CAS(ptr, oval, nval) (_InterlockedCompareExchange(ptr, nval, oval) == oval)
#define ATOM_CAS8(ptr, oval, nval) (_InterlockedCompareExchange8(ptr, nval, oval) == oval)
#define ATOM_CAS16(ptr, oval, nval) (_InterlockedCompareExchange16(ptr, nval, oval) == oval)
#define ATOM_CAS32(ptr, oval, nval) (_InterlockedCompareExchange(ptr, nval, oval) == oval)
#define ATOM_CAS64(ptr, oval, nval) (_InterlockedCompareExchange64(ptr, nval, oval) == oval)
#define ATOM_CAS_POINTER(ptr, oval, nval) (_InterlockedCompareExchangePointer((void* volatile *)ptr, oval, nval) == oval)
